package com.hzih.ca.web.action.syslog;

import com.hzih.ca.crl.CrlListener;
import com.hzih.ca.entity.StatusMsg;
import com.hzih.ca.entity.SysLogServer;
import com.hzih.ca.service.LogService;
import com.hzih.ca.syslog.SysLogConfigXML;
...
public class SysLogConfigAction extends ActionSupport {
    ...
    public String add() throws Exception {
        ...
        StatusMsg statusMsg = sysLogConfigXML.add(X509Context.syslog_xml, this.sysLogServer);
        if (statusMsg.isFlag()) {
    ...
    private void reloadSysLog(){
        if( CrlListener.isRunSysLog){
            CrlListener.sysLogService.close();
            CrlListener.isRunSysLog = false;
        }
        CrlListener.sysLogService.init();
        CrlListener.sysLogService.start();
    ...
    public String find() throws Exception {
        ...
        SysLogConfigXML sysLogConfigXML = new SysLogConfigXML();
        List<SysLogServer> ipPorts = sysLogConfigXML.findAll(X509Context.syslog_xml);
